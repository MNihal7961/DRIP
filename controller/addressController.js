...
const addressbook_get = async (req, res) => {
    try {
        ...
        res.render('user-address-book', { title, userData, addressData, cartItems, cartNo })
    } catch (err) {
        console.log(err)
    }
}
...
const editaddress_get = async (req, res) => {
    ...
    try {
        ...
        res.render('user-edit-address', { title, id, userData, addressField, data, cartItems, cartNo })
...
const editaddress_post = async (req, res) => {
  ...
  console.log(req.body)
    ...
    try {
        ...
        console.log(err);
        res.status(500).send("Error occurred while updating address")
    }
}
